    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'admin'), (2, 'cliente'), (3, 'taller'), (4, 'técnico')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='usuarios.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Tecnico',
            fields=[
                ...
                ('taller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tecnicos', to='usuarios.taller')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='usuarios.customuser')),
            ],
        ),
        migrations.CreateModel(
